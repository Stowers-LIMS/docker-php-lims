...
# todo: check out source code and run post-update steps at this point
# this will require some kind of integration with the Ext container or moving the sencha tools into the php container
